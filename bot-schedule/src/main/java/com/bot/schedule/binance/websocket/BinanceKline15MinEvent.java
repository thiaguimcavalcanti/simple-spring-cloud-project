...
@Component
public class BinanceKline15MinEvent extends BinanceKlineEvent {

    @Autowired
    public BinanceKline15MinEvent(@Value("${exchanges.binance.websocket.url}") String url,
