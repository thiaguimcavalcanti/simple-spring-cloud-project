...
@Component
public class BinanceKline5MinEvent extends BinanceKlineEvent {

    @Autowired
    public BinanceKline5MinEvent(@Value("${exchanges.binance.websocket.url}") String url,
